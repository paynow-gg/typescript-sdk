...
export declare const getStoresAffiliateLinks: <TData = AxiosResponse<AffiliateLinkDto[]>>(storeId: number, options?: AxiosRequestConfig) => Promise<TData>;
export declare const postStoresAffiliateLink: <TData = AxiosResponse<AffiliateLinkDto>>(storeId: number, createAffiliateLinkDto: CreateAffiliateLinkDto, options?: AxiosRequestConfig) => Promise<TData>;
export declare const getStoresAffiliateLink: <TData = AxiosResponse<AffiliateLinkDto>>(storeId: number, id: number, options?: AxiosRequestConfig) => Promise<TData>;
export declare const patchStoresAffiliateLink: <TData = AxiosResponse<AffiliateLinkDto>>(storeId: number, id: number, updateAffiliateLinkDto: UpdateAffiliateLinkDto, options?: AxiosRequestConfig) => Promise<TData>;
export declare const deleteStoresAffiliateLink: <TData = AxiosResponse<void>>(storeId: number, id: number, options?: AxiosRequestConfig) => Promise<TData>;
export declare const getStoresBans: <TData = AxiosResponse<BanDto[]>>(storeId: number, params?: GetStoresBansParams, options?: AxiosRequestConfig) => Promise<TData>;
export declare const postStoresBan: <TData = AxiosResponse<BanDto>>(storeId: number, upsertBanRequestDto: UpsertBanRequestDto, options?: AxiosRequestConfig) => Promise<TData>;
export declare const getStoresBan: <TData = AxiosResponse<BanDto>>(storeId: number, id: number, options?: AxiosRequestConfig) => Promise<TData>;
export declare const patchStoresBan: <TData = AxiosResponse<BanDto>>(storeId: number, id: number, upsertBanRequestDto: UpsertBanRequestDto, options?: AxiosRequestConfig) => Promise<TData>;
export declare const deleteStoresBan: <TData = AxiosResponse<void>>(storeId: number, id: number, options?: AxiosRequestConfig) => Promise<TData>;
export declare const postStoresBanCheck: <TData = AxiosResponse<CheckForBanIDByIdentitiesRequestDto>>(storeId: number, checkForBanIDByIdentitiesRequestDto: CheckForBanIDByIdentitiesRequestDto, options?: AxiosRequestConfig) => Promise<TData>;
/**
 ...
 */
export declare const postStoresCheckout: <TData = AxiosResponse<CreateCheckoutSessionResponseDto>>(storeId: string, createCheckoutSessionManagementDto: CreateCheckoutSessionManagementDto, options?: AxiosRequestConfig) => Promise<TData>;
export declare const postStoresCoupon: <TData = AxiosResponse<CouponDto>>(storeId: number, couponDto: CouponDto, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * @summary Fetches all coupons for a store id
 */
export declare const getStoresCoupons: <TData = AxiosResponse<CouponDto[]>>(storeId: number, params?: GetStoresCouponsParams, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * @summary Retrieves a coupon by ID
 */
export declare const getStoresCoupon: <TData = AxiosResponse<CouponDto>>(storeId: number, couponId: number, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * @summary Performs a Delta Update of a Coupon
 */
export declare const patchStoresCoupon: <TData = AxiosResponse<CouponDto>>(storeId: number, couponId: number, couponDto: CouponDto, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * @summary Deletes a coupon
 */
export declare const deleteStoresCoupon: <TData = AxiosResponse<void>>(storeId: number, couponId: number, options?: AxiosRequestConfig) => Promise<TData>;
/**
 ...
 */
export declare const postStoresCustomVariable: <TData = AxiosResponse<CustomVariableDto>>(storeId: number, upsertCustomVariableRequestDto: UpsertCustomVariableRequestDto, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Retrieves all custom variables for the specified store.
 * @summary Get custom variables
 */
export declare const getStoresCustomVariables: <TData = AxiosResponse<CustomVariableDto[]>>(storeId: number, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Retrieves a specific custom variable by ID from the specified store.
 * @summary Get custom variable
 */
export declare const getStoresCustomVariable: <TData = AxiosResponse<CustomVariableDto>>(storeId: number, customVariableId: number, options?: AxiosRequestConfig) => Promise<TData>;
/**
 ...
 */
export declare const patchStoresCustomVariable: <TData = AxiosResponse<CustomVariableDto>>(storeId: number, customVariableId: number, upsertCustomVariableRequestDto: UpsertCustomVariableRequestDto, options?: AxiosRequestConfig) => Promise<TData>;
/**
 ...
 */
export declare const deleteStoresCustomVariable: <TData = AxiosResponse<void>>(storeId: number, customVariableId: number, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Retrieves all customers for the specified store.
 * @summary Get customers
 */
export declare const getStoresCustomers: <TData = AxiosResponse<CustomerDto[]>>(storeId: number, params?: GetStoresCustomersParams, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Creates a new customer based on the fields passed.
 * @summary Create customer
 */
export declare const postStoresCustomer: <TData = AxiosResponse<CustomerDto>>(storeId: number, upsertCustomerRequestDto: UpsertCustomerRequestDto, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Retrieves a customer by the ID for the specified store.
 * @summary Get customer by ID
 */
export declare const getStoresCustomer: <TData = AxiosResponse<CustomerDto>>(storeId: number, customerId: number, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Updates an existing customer based on the fields passed.
 * @summary Update customer
 */
export declare const patchStoresCustomer: <TData = AxiosResponse<CustomerDto>>(storeId: number, customerId: number, upsertCustomerRequestDto: UpsertCustomerRequestDto, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Generates a customer token that can be used by the Storefront (Headless) API.
 * @summary Create customer token
 */
export declare const postStoresCustomerToken: <TData = AxiosResponse<CustomerTokenResponseDto>>(storeId: number, customerId: number, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Invalidates all generated customer tokens.
 * @summary Invalidate customer tokens
 */
export declare const deleteStoresCustomerToken: <TData = AxiosResponse<void>>(storeId: number, customerId: number, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Looks up a customer by an external platform ID.
 * @summary Lookup customer
 */
export declare const getStoresCustomerLookup: <TData = AxiosResponse<CustomerDto>>(storeId: number, params?: GetStoresCustomerLookupParams, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Creates up to 200 customers at once.
 * @summary Bulk create customers
 */
export declare const postStoresCustomerBulk: <TData = AxiosResponse<CustomerDto[]>>(storeId: number, upsertCustomerRequestDto: UpsertCustomerRequestDto[], options?: AxiosRequestConfig) => Promise<TData>;
export declare const getStoresDataMigrations: <TData = AxiosResponse<DataMigrationTaskDto[]>>(storeId: number, params?: GetStoresDataMigrationsParams, options?: AxiosRequestConfig) => Promise<TData>;
export declare const postStoresDataMigrationTebex: <TData = AxiosResponse<DataMigrationTaskDto[]>>(storeId: number, startDataMigrationFromTebexRequestDto: StartDataMigrationFromTebexRequestDto, options?: AxiosRequestConfig) => Promise<TData>;
export declare const postStoresDeliverableCommandsResend: <TData = AxiosResponse<ResendCommandsForGameServerResponseDto>>(storeId: number, deliverableId: number, resendCommandsForGameServerRequestDto: ResendCommandsForGameServerRequestDto, options?: AxiosRequestConfig) => Promise<TData>;
export declare const getV1StoresStoreIdProductVersionsProductVersionIdDiscordActions: <TData = AxiosResponse<DiscordActionDto[]>>(storeId: number, productVersionId: number, options?: AxiosRequestConfig) => Promise<TData>;
export declare const putV1StoresStoreIdProductVersionsProductVersionIdDiscordActions: <TData = AxiosResponse<DiscordActionDto>>(storeId: number, productVersionId: number, setDiscordActionDto: SetDiscordActionDto[], options?: AxiosRequestConfig) => Promise<TData>;
export declare const getV1StoresStoreIdOrdersOrderIdDiscord: <TData = AxiosResponse<GetV1StoresStoreIdOrdersOrderIdDiscord200>>(storeId: number, orderId: number, options?: AxiosRequestConfig) => Promise<TData>;
export declare const getV1StoresStoreIdOrdersOrderIdDiscordQueued: <TData = AxiosResponse<QueuedDiscordActionDto[]>>(storeId: number, orderId: number, options?: AxiosRequestConfig) => Promise<TData>;
export declare const getV1StoresStoreIdInventoryInventoryItemIdDiscordQueued: <TData = AxiosResponse<QueuedDiscordActionDto[]>>(storeId: number, inventoryItemId: number, options?: AxiosRequestConfig) => Promise<TData>;
export declare const getV1StoresStoreIdInventoryInventoryItemIdDiscordLink: <TData = AxiosResponse<DiscordProfileDto>>(storeId: number, inventoryItemId: number, options?: AxiosRequestConfig) => Promise<TData>;
export declare const putV1StoresStoreIdInventoryInventoryItemIdDiscordLink: <TData = AxiosResponse<void>>(storeId: number, inventoryItemId: number, params?: PutV1StoresStoreIdInventoryInventoryItemIdDiscordLinkParams, options?: AxiosRequestConfig) => Promise<TData>;
export declare const deleteV1StoresStoreIdInventoryInventoryItemIdDiscordLink: <TData = AxiosResponse<void>>(storeId: number, inventoryItemId: number, options?: AxiosRequestConfig) => Promise<TData>;
export declare const postV1StoresStoreIdDiscordLinks: <TData = AxiosResponse<DiscordServerLinkDto>>(storeId: number, options?: AxiosRequestConfig) => Promise<TData>;
export declare const getV1StoresStoreIdDiscordLinks: <TData = AxiosResponse<DiscordServerLinkDto[]>>(storeId: number, options?: AxiosRequestConfig) => Promise<TData>;
export declare const deleteV1StoresStoreIdDiscordLinksToken: <TData = AxiosResponse<DiscordServerLinkDto[]>>(storeId: number, token: string, options?: AxiosRequestConfig) => Promise<TData>;
export declare const getV1StoresStoreIdDiscordDiscordServerIdRoles: <TData = AxiosResponse<DiscordServerRoleDto[]>>(storeId: number, discordServerId: number, options?: AxiosRequestConfig) => Promise<TData>;
export declare const getV1StoresStoreIdDiscordDiscordServerIdDiscordTextChannels: <TData = AxiosResponse<DiscordServerChannelDto[]>>(storeId: number, discordServerId: number, options?: AxiosRequestConfig) => Promise<TData>;
export declare const getStoresProductDownloadableFiles: <TData = AxiosResponse<ProductDownloadableFileDto[]>>(storeId: number, productId: number, options?: AxiosRequestConfig) => Promise<TData>;
export declare const postStoresProductDownloadableFiles: <TData = AxiosResponse<void>>(storeId: number, productId: number, startDownloadableFileUploadRequestDto: StartDownloadableFileUploadRequestDto, options?: AxiosRequestConfig) => Promise<TData>;
export declare const postStoresProductDownloadableFileUploadFinish: <TData = AxiosResponse<void>>(storeId: number, productId: number, id: number, options?: AxiosRequestConfig) => Promise<TData>;
export declare const getStoresProductDownloadableFileDownloadUrl: <TData = AxiosResponse<CreateDownloadableFileDownloadUrlResponseDto>>(storeId: number, productId: number, id: number, options?: AxiosRequestConfig) => Promise<TData>;
export declare const deleteStoresProductDownloadableFile: <TData = AxiosResponse<void>>(storeId: number, productId: number, id: number, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Retrieves all global commands for the specified store.
 * @summary Get global commands
 */
export declare const getStoresGlobalCommands: <TData = AxiosResponse<GlobalCommandDto[]>>(storeId: number, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Creates a global command for a store.
 * @summary Create global command
 */
export declare const postStoresGlobalCommand: <TData = AxiosResponse<GlobalCommandDto>>(storeId: number, upsertGlobalCommandDto: UpsertGlobalCommandDto, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Updates a global command for a store.
 * @summary Update global command
 */
export declare const patchStoresGlobalCommand: <TData = AxiosResponse<GlobalCommandDto>>(storeId: number, globalCommandId: FlakeId, upsertGlobalCommandDto: UpsertGlobalCommandDto, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Deletes a global command for a store.
 * @summary Delete global command
 */
export declare const deleteStoresGlobalCommand: <TData = AxiosResponse<void>>(storeId: number, globalCommandId: FlakeId, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * @summary Gets the abandoned checkout behaviour for a store
 */
export declare const getStoresAbandonedCheckoutConfiguration: <TData = AxiosResponse<AbandonedCheckoutStoreConfigurationDto>>(storeId: number, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * @summary Sets the abandoned checkout behaviour for a store
 */
export declare const putStoresAbandonedCheckoutConfiguration: <TData = AxiosResponse<AbandonedCheckoutStoreConfigurationDto | undefined>>(storeId: number, abandonedCheckoutStoreConfigurationUpdateDto: AbandonedCheckoutStoreConfigurationUpdateDto, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * @summary Gets the purchase follow up behaviour for a store
 */
export declare const getStoresPurchaseFollowUpsConfiguration: <TData = AxiosResponse<PurchaseFollowUpStoreConfigurationDto>>(storeId: number, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * @summary Sets the purchase follow up behaviour for a store
 */
export declare const putStoresPurchaseFollowUpsConfiguration: <TData = AxiosResponse<PurchaseFollowUpStoreConfigurationDto | undefined>>(storeId: number, purchaseFollowUpStoreConfigurationUpdateDto: PurchaseFollowUpStoreConfigurationUpdateDto, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Retrieves all orders for the specified store.
 * @summary Get orders
 */
export declare const getStoresOrders: <TData = AxiosResponse<OrderDto[]>>(storeId: number, params?: GetStoresOrdersParams, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Retrieves an order by the ID for the specified store.
 * @summary Get order by ID
 */
export declare const getStoresOrder: <TData = AxiosResponse<OrderDto>>(storeId: number, orderId: FlakeId, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Creates a refund for an order by the ID for the specified store.
 * @summary Refund order by ID
 */
export declare const postStoresOrderRefund: <TData = AxiosResponse<RefundDto>>(storeId: number, orderId: FlakeId, createRefundRequestDto: CreateRefundRequestDto, options?: AxiosRequestConfig) => Promise<TData>;
/**
 ...
 */
export declare const getStoresProducts: <TData = AxiosResponse<ProductDto[]>>(storeId: number, options?: AxiosRequestConfig) => Promise<TData>;
/**
 ...
 */
export declare const postStoresProduct: <TData = AxiosResponse<ProductDto>>(storeId: number, upsertProductRequestDto: UpsertProductRequestDto, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Retrieves a specific product by ID from the specified store.
DO NOT USE THIS ROUTE FOR DISPLAYING PRODUCTS ON YOUR STOREFRONT, use the storefront API instead.
 * @summary Get product
 */
export declare const getStoresProduct: <TData = AxiosResponse<ProductDto>>(storeId: number, productId: number, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Updates an existing product in the specified store.
 * @summary Update product
 */
export declare const patchStoresProduct: <TData = AxiosResponse<ProductDto>>(storeId: number, productId: number, upsertProductRequestDto: UpsertProductRequestDto, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Deletes a product from the specified store.
 * @summary Delete product
 */
export declare const deleteStoresProduct: <TData = AxiosResponse<void>>(storeId: number, productId: number, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Updates the sort order of products in the specified store.
 * @summary Update product sort order
 */
export declare const postStoresProductSortOrder: <TData = AxiosResponse<ProductDto>>(storeId: number, updateProductSortOrderRequestDto: UpdateProductSortOrderRequestDto, options?: AxiosRequestConfig) => Promise<TData>;
export declare const getStoresProductPricingRegions: <TData = AxiosResponse<ProductPricingRegionDto[]>>(storeId: number, productId: number, options?: AxiosRequestConfig) => Promise<TData>;
export declare const patchStoresProductPricingRegion: <TData = AxiosResponse<void>>(storeId: number, productId: number, regionId: string, productPricingRegionOverrideDto: ProductPricingRegionOverrideDto, options?: AxiosRequestConfig) => Promise<TData>;
export declare const getStoresPricingRegions: <TData = AxiosResponse<ProductPricingRegionDto[]>>(storeId: number, options?: AxiosRequestConfig) => Promise<TData>;
export declare const patchStoresPricingRegion: <TData = AxiosResponse<void>>(storeId: number, regionId: string, storePricingRegionOverrideDto: StorePricingRegionOverrideDto, options?: AxiosRequestConfig) => Promise<TData>;
export declare const getStoresPricingRegionGroups: <TData = AxiosResponse<ProductPricingRegionGroupDto[]>>(storeId: number, options?: AxiosRequestConfig) => Promise<TData>;
export declare const getStoresStoreTrustOnboarding: <TData = AxiosResponse<TrustStoreOnboardingDto>>(storeId: number, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Retrieves all subscriptions for the specified store.
 * @summary Get subscriptions
 */
export declare const getStoresSubscriptions: <TData = AxiosResponse<StoreSubscriptionDto[]>>(storeId: number, params?: GetStoresSubscriptionsParams, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Retrieves a subscription for the specified store by the supplied ID.
 * @summary Get subscription by ID
 */
export declare const getStoresSubscription: <TData = AxiosResponse<StoreSubscriptionDto>>(storeId: number, subscriptionId: FlakeId, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Cancels a subscription for the specified store by the supplied ID.
 * @summary Cancel subscription by ID
 */
export declare const postStoresSubscriptionCancel: <TData = AxiosResponse<void>>(storeId: number, subscriptionId: FlakeId, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Retrieves an image upload URL for a tag.
 * @summary Get tag image upload URL
 */
export declare const getStoresTagImageUploadUrl: <TData = AxiosResponse<GetTagImageUploadUrlResponseDto>>(storeId: number, tagId: number, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Finishes an image upload for a tag.
 * @summary Finish tag image upload URL
 */
export declare const postStoresTagImageUploadFinish: <TData = AxiosResponse<void>>(storeId: number, tagId: number, finishTagImageUploadUrlRequestDto: FinishTagImageUploadUrlRequestDto, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Deletes an image for a tag.
 * @summary Delete tag image URL
 */
export declare const deleteStoresTagImage: <TData = AxiosResponse<void>>(storeId: number, tagId: number, options?: AxiosRequestConfig) => Promise<TData>;
export declare const getStoresWebhooks: <TData = AxiosResponse<WebhookSubscriptionDto[]>>(storeId: number, options?: AxiosRequestConfig) => Promise<TData>;
export declare const postStoresWebhook: <TData = AxiosResponse<WebhookSubscriptionDto>>(storeId: number, createWebhookDto: CreateWebhookDto, options?: AxiosRequestConfig) => Promise<TData>;
export declare const getStoresWebhookVariables: <TData = AxiosResponse<WebhookVariablesDto[]>>(storeId: number, options?: AxiosRequestConfig) => Promise<TData>;
export declare const patchStoresWebhook: <TData = AxiosResponse<WebhookSubscriptionDto>>(storeId: number, webhookId: number, updateWebhookDto: UpdateWebhookDto, options?: AxiosRequestConfig) => Promise<TData>;
export declare const deleteStoresWebhook: <TData = AxiosResponse<void>>(storeId: number, webhookId: number, options?: AxiosRequestConfig) => Promise<TData>;
export declare const getStoresWebhookHistory: <TData = AxiosResponse<WebhookHistoryDto>>(storeId: number, webhookId: number, params?: GetStoresWebhookHistoryParams, options?: AxiosRequestConfig) => Promise<TData>;
...
export type PutStoresAbandonedCheckoutConfigurationResult = AxiosResponse<AbandonedCheckoutStoreConfigurationDto | undefined>;
export type GetStoresPurchaseFollowUpsConfigurationResult = AxiosResponse<PurchaseFollowUpStoreConfigurationDto>;
export type PutStoresPurchaseFollowUpsConfigurationResult = AxiosResponse<PurchaseFollowUpStoreConfigurationDto | undefined>;
