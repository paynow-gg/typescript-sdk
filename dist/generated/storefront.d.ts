 ...
 * @summary Get cart
 */
export declare const getStorefrontCart: <TData = AxiosResponse<CartDto>>(params?: GetStorefrontCartParams, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Clears all items from the customer's shopping cart.
 * @summary Clear cart
 */
export declare const deleteStorefrontCart: <TData = AxiosResponse<void>>(options?: AxiosRequestConfig) => Promise<TData>;
/**
 ...
 */
export declare const putStorefrontCartLine: <TData = AxiosResponse<void>>(params: PutStorefrontCartLineParams, options?: AxiosRequestConfig) => Promise<TData>;
/**
 ...
 */
export declare const postStorefrontCartCheckoutSession: <TData = AxiosResponse<CreateCheckoutSessionResponseDto>>(createCartCheckoutSessionDto: CreateCartCheckoutSessionDto, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Creates a checkout session using a Customer token.
After creating the checkout session, redirect the customer to the `url` returned.
 * @summary Create a checkout session
 */
export declare const postStorefrontCheckoutSession: <TData = AxiosResponse<CreateCheckoutSessionResponseDto>>(createCheckoutSessionRequestDto: CreateCheckoutSessionRequestDto, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Retrieves the current customer from the passed Customer token.
 * @summary Get current customer
 */
export declare const getStorefrontCurrentCustomer: <TData = AxiosResponse<CustomerDto>>(options?: AxiosRequestConfig) => Promise<TData>;
export declare const getV1StoresStoreIdProductVersionsDiscordActions: <TData = AxiosResponse<GetV1StoresStoreIdProductVersionsDiscordActions200>>(storeId: number, params?: GetV1StoresStoreIdProductVersionsDiscordActionsParams, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Retrieves the store's navlink structure used for navigation.
 * @summary Get navlinks
 */
export declare const getStorefrontNavlinks: <TData = AxiosResponse<StorefrontNavLinkDto[]>>(options?: AxiosRequestConfig) => Promise<TData>;
/**
 ...
 */
export declare const getStorefrontProducts: <TData = AxiosResponse<StorefrontProductDto[]>>(params?: GetStorefrontProductsParams, options?: AxiosRequestConfig) => Promise<TData>;
/**
 ...
 */
export declare const getStorefrontProduct: <TData = AxiosResponse<StorefrontProductDto>>(idOrSlug: string, params?: GetStorefrontProductParams, options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Retrieves a store by the passed in x-paynow-store-id or Customer token.
 * @summary Get current store
 */
export declare const getStorefrontStore: <TData = AxiosResponse<StorefrontStoreDto>>(options?: AxiosRequestConfig) => Promise<TData>;
/**
 * Retrieves the store's tags.
 * @summary Get tags
 */
export declare const getStorefrontTags: <TData = AxiosResponse<StorefrontTagDto[]>>(options?: AxiosRequestConfig) => Promise<TData>;
...
export type PostStorefrontCartCheckoutSessionResult = AxiosResponse<CreateCheckoutSessionResponseDto>;
export type PostStorefrontCheckoutSessionResult = AxiosResponse<CreateCheckoutSessionResponseDto>;
export type GetStorefrontCurrentCustomerResult = AxiosResponse<CustomerDto>;
export type GetV1StoresStoreIdProductVersionsDiscordActionsResult = AxiosResponse<GetV1StoresStoreIdProductVersionsDiscordActions200>;
